 ...
 * </p>
 */
public class MapDBSharedStringsTable extends SharedStringsTable {
     ...
     */
    private final HTreeMap<Integer, CTRst> strings;

    /**
     *  Maps strings and their indexes in the <code>strings</code> arrays
     */
    private final HTreeMap<String, Integer> stmap;
    ...
    public MapDBSharedStringsTable() {
        this(false);
    }

    public MapDBSharedStringsTable(boolean fullFormat) {
        super();
    ...
    public MapDBSharedStringsTable(OPCPackage pkg) throws IOException {
        this(pkg, false);
    }

    public MapDBSharedStringsTable(OPCPackage pkg, boolean fullFormat) throws IOException {
        this(fullFormat);
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        try {
            ...
            writer.write("\">");
            Iterator<Integer> idIter = strings.keySet().iterator();
